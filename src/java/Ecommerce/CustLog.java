...
public class CustLog extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CustLog</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            if(rs.next())
            {
                request.getRequestDispatcher("online.html").include(request, response);
            }
            else
            {
                out.println("<script>alert('Invalid EmailId/Password');</script>");
